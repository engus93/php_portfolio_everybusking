...
<head>
    ...
    <title>Every Busking - Busking Zone</title>
    ...
    <link href="../busking_zone/busking_zone.css" rel="stylesheet">
...
<div class="container" style="min-height: 900px;">
    ...
    <h1 class="mt-4 mb-3 my_font_index" style="padding-bottom: 100px">Busking Zone</h1>

    <section class="search-box" style="border: #FBAA48 1px solid; padding: 30px; border-radius: 20px;">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 listing-block" style="border-radius: 5px; height: 100%">
                    <div class="media" onclick="">
                        <img class="d-flex align-self-start"
                             src="/img/남성역.jpg"
                             alt="Generic placeholder image">
                        <div class="media-body pl-3">
                            <div class="price">남성역</div>
                            <div class="stats">
                                <span><i class="fas fa-guitar"></i>금요일 8시</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="media" onclick="">
                        <img class="d-flex align-self-start"
                             ...
                             alt="Generic placeholder image">
                        <div class="media-body pl-3">
                            <div class="price">삼일 공원</div>
                            <div class="stats">
                                <span><i class="fas fa-guitar"></i>금요일 8시</span>
                                <span><i class="fas fa-guitar"></i>토요일 9시</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="media" onclick="">
                        <img class="d-flex align-self-start"
                             ...
                             alt="Generic placeholder image">
                        <div class="media-body pl-3">
                            <div class="price">이수역</div>
                            <div class="stats">
                                <span><i class="fas fa-guitar"></i>토요일 8시</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-7">
                    <div id="map" style="width:auto; height: 500px; border: #FBAA48 1px solid; border-radius: 5px">
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=2154cbb07be5a1c2a555e612b400e884"></script>
<script>
    /**
    ...
    var mapContainer = document.getElementById('map'), // 지도를 표시할 div
        mapOption = {
            center: new daum.maps.LatLng(37.484678283943886, 126.97132633011952), // 지도의 중심좌표
            level: 3 // 지도의 확대 레벨
        };
    ...
    // 이수
    var dkpos1 = new daum.maps.LatLng(37.485166856316326, 126.9814795830385);
    // 남성
    var dkpos2 = new daum.maps.LatLng(37.484678283943886, 126.97132633011952);
    // 고객 센터
    var dkpos3 = new daum.maps.LatLng(37.47644511025159, 126.98161740049366);
    // 고객 센터
    var dkpos4 = new daum.maps.LatLng(37.48502153278682, 126.97514786478435);
    ...
    var marker4 = new TooltipMarker(dkpos4, 'kwqeqo 고객센터');
    marker1.setMap(map);
    marker2.setMap(map);
    marker3.setMap(map);
    marker4.setMap(map);
