...
<div class="container my_font_main" style="min-height: 800px">
    ...
    <ol class="breadcrumb" style="background-color: transparent">
        ...
        <li class="breadcrumb-item">
            <a href="manager_application_processing.php" style="color: #fc3c3c">처리 내역</a>
        </li>
    ...
    <div style="position: relative;margin-left:45px; margin-top: 50px">
        ...
        <table class="list-table">
            ...
            $sql = mq("select * from application_tb where whether = '승락' or '거절'");
            ...
            //        끝
            $sql = mq("select COUNT(*) from application_tb where whether = '승락' or '거절'");

            $num = mysqli_fetch_array($sql);

            $num = ($num[0] + 1) - ($page - 1) * $list;

            $sql = mq("select * from application_tb where whether = '승락' or '거절' order by idx desc limit $start_num, $list");
