...
<div class="container my_font_main" style="min-height: 800px">
    ...
    <ol class="breadcrumb">
        ...
        <?php
            ...
            <li class="breadcrumb-item">
                <a href="manager_community.php" style="color: #fc3c3c">Community</a>
            </li>
    ...
    <!-- Page Heading/Breadcrumbs -->
    <h4 class="my_font_main" style="margin-top: 50px;">커뮤니티</h4>
    ...
    <div style="position: relative;margin-left:15px; margin-top: 50px">
        ...
        <table class="list-table">
            ...
            $sql = mq("select COUNT(*) from community_tb");

            $num = mysqli_fetch_array($sql);

            $num = ($num[0] + 1) - ($page - 1) * $list;

            $sql = mq("select * from community_tb order by date desc limit $start_num, $list");
            ...
            <tr>
                ...
                <td width="200">
                    <form style="display: inline" method="get" action="/community/community_read.php">
                    ...
                    <form style="display: inline" method="get" action="/community/community_write.php">
                        <input type="hidden" name="idx" value="<?= $board['idx'] ?>">
                        <input type="hidden" name="manager_page" value="<?= $page ?>">
                        <button type="submit" id="support_hover" class="btn hover_class"
                                style="font-size: 12px; padding: 3px 7px 3px 7px">
                    ...
                    <form style="display: inline" method="get" action="/community/community_delete_p.php">
                        <input type="hidden" name="idx" value="<?= $board['idx'] ?>">
                        <input type="hidden" name="manager_page" value="<?= $page ?>">
                        <button type="submit" id="support_hover" class="btn hover_class"
                                style="font-size: 12px; padding: 3px 7px 3px 7px">
