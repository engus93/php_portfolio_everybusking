    ...
    if (!move_uploaded_file($tempName, $filePath)) {
        if(!empty($_FILES["file"]["error"])) {
            $listOfErrors = array(
                ...
                '8' => 'A PHP extension stopped the file uploads. PHP does not provide a way to ascertain which extension caused the file uploads to stop; examining the list of loaded extensions with phpinfo() may help.'
            );
